...
def simulate(start_date, end_date, symbols_list, allocation_list):
    ...
    betas_list = finance.calcAllBetas2([start_date.year, start_date.month, start_date.day], [end_date.year, end_date.month, end_date.day], symbols_list)
    pBeta = sum(n for _, n in betas_list) / 4.0
    ...
    beta_arr = np.array([x[1] for x in betas_list])
